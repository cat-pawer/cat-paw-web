...
function ProjectDetailPage() {
    const List = [
        {
            intro: "프로젝트에 대한 내용은 이곳에 노출합니다. 프로젝트 생성자가 작성한 내용이에요.\n" +
                "프로젝트에 대한 내용은 이곳에 노출합니다. 프로젝트 생성자가 작성한 내용이에요.프로젝트에 대한 내용은\n" +
                " 이곳에 노출합니다. 프로젝트 생성자가 작성한 내용이에요.",
            progress: "프로젝트를 이렇게 이끌어 갈거에요. 그래서 지금 이렇게 사람들을 모집해요.\n" +
            ...
            qualification: "자기계발과 성장에 대한 욕심이 있으신 분\n" +
                "개발 분야에 대한 역량이 있으신 분\n" +
                "성실한 프로젝트 참여가 가능한 분",
            treatment: "열정 보여줄 수 있는 분",
            treatment2: "사이드 프로젝트 (100% 재택)\n" +
    ...
    const commentList = [
        {
            nickname: "닉넴1",
            content: "내용111111111111111111111111111111111111111111111111111111111111"
        },
        {
            nickname: "닉넴2",
            content: "내용22222222222222222222222222222222222222222222222222222222222222222"
        },
        {
            nickname: "닉넴3",
            content: "댓글입니다 댓글입니다 댓글입니다 댓글 댓글 긴 댓글입니다. 댓글입니다 댓글입니다 댓글입니다 댓글 댓글 긴 댓글입니다. 댓글입니다 댓글입니다 댓글입니다 댓글 댓글 긴 댓글입니다. "
        },
        {
            nickname: "닉넴4",
            content: "짧댓"
            ...
            <div className="detail-section3">
                ...
                <div className="detail-subInfo">
                    {commentList.map((comment, index) => (
                        <div className="detail-subInfo-wrap">
                            ...
                            {index === commentList.length - 1 ?
                                null : (<div className="detail-subInfo-wrap-line"></div>)}
                        </div>
                    ))}
                </div>
            </div>

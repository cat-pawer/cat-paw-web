...
function NoticeList() {
    ...
    const noticeList = [
        {
            title: "공지사항1",
            content: "작성한 상세 내용은 이렇게 보여집니다. 공유한 내용을 다 확인하였다면, 화살표를 눌러서 닫을 수 있습니다. 글 작성은 상단의 추가 버튼을 클릭 하면 해당 형태가 노출됩니다." +
    ...
    return (
        <div className="my-notice-info">
            ...
            <div key={index} className={isModal && modalIndex === index ? "my-notice-info-modalOn" : "my-notice-info-modal"}>
                <div className="my-notice-info-modal-info">
                    <div className="my-notice-info-modal-info-title">
                        ...
                        <div className="my-notice-info-modal-info-title-edit"><span>편집</span></div>
                    </div>
                    {isModal && modalIndex === index ?
                        <div className="my-notice-info-modal-info-angle" onClick={() => closeModal(index)}>
                            <FontAwesomeIcon
                                icon={faAngleUp}
                                className="angleDown"
                            />
                             ...
                             :
                        <div className="my-notice-info-modal-info-angle" onClick={() =>openModal(index)}>
                            <FontAwesomeIcon
                                icon={faAngleDown}
                                className="angleDown"
                            />

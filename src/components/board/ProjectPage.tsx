...
function ProjectPage() {
    ...
    const List = [
        ...
        {
            division: "📓프로젝트",
            subTitle: "[프론트/백개발자] 함께 000 프로젝트 성실하게 임하실 분 구해요. 주 1회 온라인으로만 만나서 빠르게 진행하려고합니다.",
            tag: "#프론트 #백 #개발자",
            date: "23.10.12",
            hits: "367",
            comment: "488",
        ...
        {
            division: "📙스터디",
            subTitle: "[프론트/백개발자] 함께 000 프로젝트 성실하게 임하실 분 구해요. 주 1회 온라인으로만 만나서 빠르게 진행하려고합니다. 어쩌구 저쩌구 이러쿵 저러쿵",
            tag: "#프론트 #백 #개발자",
            date: "23.10.12",
            hits: "367",
            comment: "32",
    ...
    return (
        <div className="whole-project">
            ...
            <div className="whole-project-list">
                {List.map((info, index) => (
                    <div className="whole-project-card">
                        <div className="whole-project-list-card" key={index}
                            ...
                            <div className="whole-project-list-card-bottom">
                                <div className="whole-project-list-card-bottom-language">
                                    {info.language.map((item, itemIndex) => (
                                        <div key={itemIndex} className="whole-project-list-card-bottom-language-list">
